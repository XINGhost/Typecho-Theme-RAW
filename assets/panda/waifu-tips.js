...
$('.waifu-tool .l2d-home').click(function (){
    showMessage('让我们回到开始的地方', 3000, true);
});

$('.waifu-tool .l2d-eye').click(function (){
    switchNightMode();
    showMessage('你会做眼保健操吗？', 3000, true);
});

$('.waifu-tool .l2d-chat').click(function (){
    showHitokoto();
});

$('.waifu-tool .l2d-cross').click(function (){
    showMessage('我们还能再见面的吧…', 1300, true);
    window.setTimeout(function() {$('.waifu').hide();}, 1300);
});

$('.waifu-tool .l2d-photo').click(function (){
...
$.ajax({
    cache: true,
    url: "/usr/themes/RAW/assets/panda/waifu-tips.json",
    dataType: "json",
...
(function (){
    ...
    if(referrer.href !== '' && referrer.hostname != 'imalan.cn'){
        var referrer = document.createElement('a');
        referrer.href = document.referrer;
